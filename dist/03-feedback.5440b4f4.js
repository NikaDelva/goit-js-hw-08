...
const fillContactForm = ()=>{
    ...
    if (userInfoLS === null) return;
    for(const key in userInfoLS)formEl.elements[key].value = userInfoLS[key];
};
fillContactForm();
...
formEl.addEventListener("input", (0, _lodashThrottleDefault.default)(onFieldsInput, 500));
